...
import com.hust.techhire.domain.payload.response.CurriculumVitaeResponse;
...
public class JobseekersController {
    ...
    private ResponseEntity<String> createNewCv(@RequestParam String name, @RequestParam MultipartFile avatar, @RequestParam String cvDetail) {
        return new ResponseEntity<>(jobseekerService.createCV(name, avatar, cvDetail), HttpStatus.CREATED);
    }
