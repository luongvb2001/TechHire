    ...
    render() {
        return (
            <ul className="sidebar-nav">
                ...
                <li className="sidebar-item">
                    <NavLink to="/create-cv" className="sidebar-link">
                        <i className="align-middle" data-feather="sliders"></i> <span className="align-middle">Tạo CV</span>
                    </NavLink>
                </li>
                <li className="sidebar-item">
                    <NavLink to="/add-cv" className="sidebar-link">
                        <i className="align-middle" data-feather="sliders"></i> <span className="align-middle">Tải lên CV</span>
                    </NavLink>
                </li>
                <li className="sidebar-item">
